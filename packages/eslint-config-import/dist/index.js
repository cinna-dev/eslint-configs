...
const {fixupPluginRules: fixupPluginRules} = require("@eslint/compat");
module.exports = [{
    ...configs["typescript"],
    ...
    settings: {
        ...
        "import/resolver": {typescript: {alwaysTryTypes: true}, node: {extensions: [".js", ".jsx"]}}
    },
    ...
    rules: {
        ...
        "import/extensions": ["off", "always", {
            ignorePackages: true,
            pattern: {svg: "always", js: "never", ts: "never", tsc: "never", jsx: "never", tsx: "never", json: "never"}
        }],
        "import/first": "warn",
