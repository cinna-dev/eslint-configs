...
import * as eslint836 from "eslint";
  ...
  plugins: {
    react: {
      deprecatedRules: Partial<{
        'boolean-prop-naming': eslint836.Rule.RuleModule;
        'button-has-type': eslint836.Rule.RuleModule;
        'checked-requires-onchange-or-readonly': eslint836.Rule.RuleModule;
        'default-props-match-prop-types': eslint836.Rule.RuleModule;
        'destructuring-assignment': eslint836.Rule.RuleModule;
        'display-name': eslint836.Rule.RuleModule;
        'forbid-component-props': eslint836.Rule.RuleModule;
        'forbid-dom-props': eslint836.Rule.RuleModule;
        'forbid-elements': eslint836.Rule.RuleModule;
        'forbid-foreign-prop-types': eslint836.Rule.RuleModule;
        'forbid-prop-types': eslint836.Rule.RuleModule;
        'forward-ref-uses-ref': eslint836.Rule.RuleModule;
        'function-component-definition': eslint836.Rule.RuleModule;
        'hook-use-state': eslint836.Rule.RuleModule;
        'iframe-missing-sandbox': eslint836.Rule.RuleModule;
        'jsx-boolean-value': eslint836.Rule.RuleModule;
        'jsx-child-element-spacing': eslint836.Rule.RuleModule;
        'jsx-closing-bracket-location': eslint836.Rule.RuleModule;
        'jsx-closing-tag-location': eslint836.Rule.RuleModule;
        'jsx-curly-spacing': eslint836.Rule.RuleModule;
        'jsx-curly-newline': eslint836.Rule.RuleModule;
        'jsx-equals-spacing': eslint836.Rule.RuleModule;
        'jsx-filename-extension': eslint836.Rule.RuleModule;
        'jsx-first-prop-new-line': eslint836.Rule.RuleModule;
        'jsx-handler-names': eslint836.Rule.RuleModule;
        'jsx-indent': eslint836.Rule.RuleModule;
        'jsx-indent-props': eslint836.Rule.RuleModule;
        'jsx-key': eslint836.Rule.RuleModule;
        'jsx-max-depth': eslint836.Rule.RuleModule;
        'jsx-max-props-per-line': eslint836.Rule.RuleModule;
        'jsx-newline': eslint836.Rule.RuleModule;
        'jsx-no-bind': eslint836.Rule.RuleModule;
        'jsx-no-comment-textnodes': eslint836.Rule.RuleModule;
        'jsx-no-constructed-context-values': eslint836.Rule.RuleModule;
        'jsx-no-duplicate-props': eslint836.Rule.RuleModule;
        'jsx-no-leaked-render': eslint836.Rule.RuleModule;
        'jsx-no-literals': eslint836.Rule.RuleModule;
        'jsx-no-script-url': eslint836.Rule.RuleModule;
        'jsx-no-target-blank': eslint836.Rule.RuleModule;
        'jsx-no-useless-fragment': eslint836.Rule.RuleModule;
        'jsx-one-expression-per-line': eslint836.Rule.RuleModule;
        'jsx-no-undef': eslint836.Rule.RuleModule;
        'jsx-curly-brace-presence': eslint836.Rule.RuleModule;
        'jsx-pascal-case': eslint836.Rule.RuleModule;
        'jsx-fragments': eslint836.Rule.RuleModule;
        'jsx-props-no-multi-spaces': eslint836.Rule.RuleModule;
        'jsx-props-no-spreading': eslint836.Rule.RuleModule;
        'jsx-props-no-spread-multi': eslint836.Rule.RuleModule;
        'jsx-sort-default-props': eslint836.Rule.RuleModule;
        'jsx-sort-props': eslint836.Rule.RuleModule;
        'jsx-space-before-closing': eslint836.Rule.RuleModule;
        'jsx-tag-spacing': eslint836.Rule.RuleModule;
        'jsx-uses-react': eslint836.Rule.RuleModule;
        'jsx-uses-vars': eslint836.Rule.RuleModule;
        'jsx-wrap-multilines': eslint836.Rule.RuleModule;
        'no-invalid-html-attribute': eslint836.Rule.RuleModule;
        'no-access-state-in-setstate': eslint836.Rule.RuleModule;
        'no-adjacent-inline-elements': eslint836.Rule.RuleModule;
        'no-array-index-key': eslint836.Rule.RuleModule;
        'no-arrow-function-lifecycle': eslint836.Rule.RuleModule;
        'no-children-prop': eslint836.Rule.RuleModule;
        'no-danger': eslint836.Rule.RuleModule;
        'no-danger-with-children': eslint836.Rule.RuleModule;
        'no-deprecated': eslint836.Rule.RuleModule;
        'no-did-mount-set-state': eslint836.Rule.RuleModule;
        'no-did-update-set-state': eslint836.Rule.RuleModule;
        'no-direct-mutation-state': eslint836.Rule.RuleModule;
        'no-find-dom-node': eslint836.Rule.RuleModule;
        'no-is-mounted': eslint836.Rule.RuleModule;
        'no-multi-comp': eslint836.Rule.RuleModule;
        'no-namespace': eslint836.Rule.RuleModule;
        'no-set-state': eslint836.Rule.RuleModule;
        'no-string-refs': eslint836.Rule.RuleModule;
        'no-redundant-should-component-update': eslint836.Rule.RuleModule;
        'no-render-return-value': eslint836.Rule.RuleModule;
        'no-this-in-sfc': eslint836.Rule.RuleModule;
        'no-typos': eslint836.Rule.RuleModule;
        'no-unescaped-entities': eslint836.Rule.RuleModule;
        'no-unknown-property': eslint836.Rule.RuleModule;
        'no-unsafe': eslint836.Rule.RuleModule;
        'no-unstable-nested-components': eslint836.Rule.RuleModule;
        'no-unused-class-component-methods': eslint836.Rule.RuleModule;
        'no-unused-prop-types': eslint836.Rule.RuleModule;
        'no-unused-state': eslint836.Rule.RuleModule;
        'no-object-type-as-default-prop': eslint836.Rule.RuleModule;
        'no-will-update-set-state': eslint836.Rule.RuleModule;
        'prefer-es6-class': eslint836.Rule.RuleModule;
        'prefer-exact-props': eslint836.Rule.RuleModule;
        'prefer-read-only-props': eslint836.Rule.RuleModule;
        'prefer-stateless-function': eslint836.Rule.RuleModule;
        'prop-types': eslint836.Rule.RuleModule;
        'react-in-jsx-scope': eslint836.Rule.RuleModule;
        'require-default-props': eslint836.Rule.RuleModule;
        'require-optimization': eslint836.Rule.RuleModule;
        'require-render-return': eslint836.Rule.RuleModule;
        'self-closing-comp': eslint836.Rule.RuleModule;
        'sort-comp': eslint836.Rule.RuleModule;
        'sort-default-props': eslint836.Rule.RuleModule;
        'sort-prop-types': eslint836.Rule.RuleModule;
        'state-in-constructor': eslint836.Rule.RuleModule;
        'static-property-placement': eslint836.Rule.RuleModule;
        'style-prop-object': eslint836.Rule.RuleModule;
        'void-dom-elements-no-children': eslint836.Rule.RuleModule;
      }>;
      rules: {
        'boolean-prop-naming': eslint836.Rule.RuleModule;
        'button-has-type': eslint836.Rule.RuleModule;
