import * as eslint_plugin_react206 from "eslint-plugin-react";
import * as eslint_plugin_react_hooks208 from "eslint-plugin-react-hooks";
import * as eslint0 from "eslint";
import { Rule } from "eslint";

//#region src/withReactCompiler.d.ts
  ...
  plugins: {
    react: {
      ...
      configs: {
        ...
        flat: Record<string, eslint_plugin_react206.ReactFlatConfig>;
      } & {
        flat: Record<string, eslint_plugin_react206.ReactFlatConfig>;
      };
    };
    'jsx-a11y': Rule.RuleModule;
    'react-hooks': typeof eslint_plugin_react_hooks208;
  };
  languageOptions: {
    parserOptions: {
      ecmaFeatures: {
