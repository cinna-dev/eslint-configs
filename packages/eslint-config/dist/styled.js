...
var styled_default = _to_consumable_array(eslintConfigStyle).concat(_to_consumable_array(eslintConfigError), _to_consumable_array(eslintConfigSuggestions), _to_consumable_array(eslintConfigTs.rules), _to_consumable_array(eslintConfigReact), _to_consumable_array(eslintConfigImport));
export { styled_default as default };
