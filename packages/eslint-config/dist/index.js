...
var index_default = [
    {
        languageOptions: {
            globals: _object_spread({}, globals.browser)
        }
    }
].concat(_to_consumable_array(eslintConfigError), _to_consumable_array(eslintConfigSuggestions), _to_consumable_array(rules), _to_consumable_array(eslintConfigReact), _to_consumable_array(eslintConfigImport));
