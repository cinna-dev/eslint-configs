...
module.exports = [
    ...
    },
    {
        rules: {
            ...
            // a number of style guides require or disallow spaces between computed properties
            ...
            "max-len": ["off", {
                code: 80, ignoreComments: true, ignoreTrailingComments: true, ignoreUrls: true,
            },],
            ...
            "object-curly-spacing": ["off", "always", {arraysInObjects: false, objectsInObjects: true},],
            ...
            "padded-blocks": ["off", "never", {allowSingleLineBlocks: false}],
